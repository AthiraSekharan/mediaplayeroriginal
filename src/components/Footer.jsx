    ...
    <div style={{height:'300px'}} className='container mt-5 w-100'>
      <div className="footer-content d-flex justify-content-between">
        <div style={{width:'400px'}} className="media">
            <h5 className='d-flex'><i style={{height:'25px'}} className="fa-solid fa-cloud-meatball me-3"></i>Media Player</h5>
        ...
        <div className="contact">
            ...
            <div className='icons d-flex justify-content-between mt-3'>
              ...
              <a href="https://react.dev/" target="_blank" style={{textDecoration:'none',color:'white'}}><i class='fa-brands fa-phone fa-1x'></i></a>
